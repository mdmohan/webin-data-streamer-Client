...
public class SOCKS4Connector extends FTPConnector {
	...
	private UnifiedSocket socksConnect(String host, int port, boolean forDataTransfer) throws IOException {
		// Socks 4 or 4a?
	...
	public UnifiedSocket connectForDataTransferChannel(String host, int port)
        ...
        public UnifiedSocket connectForDataTransferChannelUDT(String host, int port) throws IOException {
		return udtConnectForDataTransferChannelUDT(host, port);
        }

        public UnifiedSocket connectForDataTransferChannelUDT(String host, int port, long size) throws IOException {
